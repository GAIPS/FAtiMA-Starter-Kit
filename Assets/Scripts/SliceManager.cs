...
public class SliceManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        serverConnectionHandler = this.GetComponent<ServerConnectionHandler>();
    ...
    {
        var text = GameObject.Find("InputField").GetComponentInChildren<Text>().text;
        serverConnectionHandler.LoadDescritpion(text);
    }
